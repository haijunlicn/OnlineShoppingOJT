...
@Component({
  selector: 'app-discount-display-for-home',
  standalone: false,
  templateUrl: './discount-display-for-home.component.html',
  styleUrl: './discount-display-for-home.component.css'
})
export class DiscountDisplayForHomeComponent  implements OnInit, OnChanges {
