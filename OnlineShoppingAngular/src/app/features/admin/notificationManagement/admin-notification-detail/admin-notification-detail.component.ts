...
@Component({
  ...
  standalone: false,
  templateUrl: './admin-notification-detail.component.html',
  styleUrl: './admin-notification-detail.component.css'
})

export class AdminNotificationDetailComponent implements OnInit, OnDestroy {
