...
@Component({
  selector: "app-new-discount-rules",
  standalone: false,
  templateUrl: "./new-discount-rules.component.html",
  styleUrls: ["./new-discount-rules.component.css"],
})
export class NewDiscountRulesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.filteredCities = [...this.myanmarCities]
  }
